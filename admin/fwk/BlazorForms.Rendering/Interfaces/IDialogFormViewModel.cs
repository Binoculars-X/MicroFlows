...
public interface IDialogFormViewModel : IFormViewModel
{
    ...
    Task LoadDialogForm(string formName, IFlowModel model, string? pk = null, FlowParamsGeneric? fps = null);
...
public interface IFragmentDialogFormViewModel : IDialogFormViewModel
{ }
