...
{
    public interface IFragmentViewModel : IFormViewModel
    {
        Task InitiateForm(string formName, IFlowModel model, string pk, FlowParamsGeneric? flowParams = null);
        /*
    ...
    //public interface IFragmentViewModel<T> : IFormViewModel where T : class, IFlowModel
    //{
    //    T Model { get; }
    //}
}
