...
namespace BlazorForms.Rendering
{
    public class ControlDialogFormViewModel : FormViewModel, IDialogFormViewModel
    {
        ...
        public Task LoadDialogForm(string formType, object model)
        {
            throw new NotImplementedException();
        }

        public Task LoadDialogForm(string formName, IFlowModel model, string? pk = null, FlowParamsGeneric? fps = null)
        {
            throw new NotImplementedException();
        }
