...
{
    //public class FragmentViewModel<T> : FragmentViewModel, IFragmentViewModel<T> where T : class, IFlowModel
    //{
    //    public T Model { get { return ModelUntyped as T; } }

    //    public FragmentViewModel(ILogger<FragmentViewModel> logger, IFlowRunProvider flowRunProvider, IDynamicFieldValidator dynamicFieldValidator,
    ...
    //    }
    //}
    public class FragmentViewModel : RenderingViewModel, IFragmentViewModel
    {
        private Dictionary<string, FieldControlDetails> _rowFields = new Dictionary<string, FieldControlDetails>();

        protected readonly ILogger<FragmentViewModel> _logger;
        ...
        public async Task InitiateForm(string formName, IFlowModel model, string pk, FlowParamsGeneric? fps = null)
        {
        ...
        {
            ClearData();
            var form = await _flowRunProvider.GetFormDetails(FormId);
            await Load(form);
        }
        ...
        protected async Task Load(FormDetails form)
        {
            ...
            var ps = Params as FlowParamsGeneric;
            ...
            IEnumerable<FieldControlDetails> allFields, FlowParamsGeneric ps)
        {
            ...
            var ruleFields = allFields.Select(f => new FlowRules.FieldDetails
            {
            ...
            var request = new RuleExecutionRequest
            {
                ...
                Fields = new Collection<FlowRules.FieldDetails>(ruleFields.ToList())
,
        ...
        public List<FormConfirmationData> GetAvailableConfirmations(ConfirmType confirmType, string? binding = null)
        {
            ...
            result.ForEach(c => 
            {
                if (c.MessageBinding != null)
                {
                    c.Message = PathNavi.GetValue(ModelUntyped, c.MessageBinding).AsString();
				}
            });
        ...
        public IFlowContextNoModel? Context => throw new NotImplementedException();

        public string? RefId => throw new NotImplementedException();
        ...
        public Task FinishFlow(string refId, string binding = null)
        {
            throw new NotImplementedException();
        }

        public Task SaveForm(string actionBinding = null, string operationName = null)
        {
            throw new NotImplementedException();
        }

        public Task SubmitForm(string binding = null, string operationName = null)
        {
            throw new NotImplementedException();
        }

        public Task RejectForm(string binding = null, string operationName = null)
        {
            throw new NotImplementedException();
        }

        public Task LoadFlowDefaultForm(string refId)
        {
            throw new NotImplementedException();
        }

        public Task<bool> CheckFormUserAccess(FormDetails form, UserViewAccessInformation accessInfo, IFlowModel model, FlowParamsGeneric flowParams)
        {
            throw new NotImplementedException();
        }
