...
namespace BlazorForms.Forms
{
    ...
    {
        protected DataFieldExtended _field;
        public DataFieldExtended Field { get { return _field; } }
    }
    ...
    public class FieldColumnBuilder<TProperty, TEntity> : FieldColumnBuilder where TEntity : class
    {
        ...
        {
            _field = new DataFieldExtended { BindingProperty = bindingProperty, DataType = typeof(TProperty) };
        }

        public FieldColumnBuilder(DataFieldExtended field)
        {
            _field = field;
        }
