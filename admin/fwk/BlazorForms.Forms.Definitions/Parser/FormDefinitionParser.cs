    ...
    public class FormDefinitionParser : IFormDefinitionParser
    {
        ...
        private FormDetails ParseFluentForm(Type formType)
        {
            ...
            foreach (var field in fields)
            {
                ...
                var newControl = new FieldControlDetailsExtended
                {
                    Name = field.Name,
                    Layout = field.Layout,
                    Group = field.Group,
                    ...
                    //MaxLength = ((DataFieldExtended)field)?.MaxLength,
                ...
                // DisplayAttribute
                newControl.DisplayProperties = new FormDisplayDetailsExtended
                {
                    Caption = field.Label,
                    ...
                    MaxLength = (field as DataFieldExtended)?.MaxLength,

                    Confirmations = field.Confirmations.Select(c => 
                    {
                        var confirmation = new FormConfirmationDetailsExtended();
                        c.ReflectionCopyTo(confirmation);
                        return confirmation as FormConfirmationDetails;
                    }).ToList(),
